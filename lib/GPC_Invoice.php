...
class GPC_Invoice
{
    ...
    public function GPC_checkInvoiceStatus($orderID)
    {
    ...
    public function GPC_createInvoice()
    {
        ...
        $request_headers[] = 'X-GatePay-Plugin-Info: ' . $pluginInfo;
    ...
    public function GPC_getInvoiceData()
    {
    ...
    public function GPC_updateBuyersEmail($invoice_result, $buyers_email)
    {
    ...
    public function GPC_updateBuyerCurrency($invoice_result, $buyer_currency)
    {
        $invoice_result = json_decode($invoice_result);
